...
@agente_scraping_bp.route('/scrape', methods=['GET'])
def scrape():
    """
    Scrapear títulos, descripciones, imágenes y gifs de una URL
    ---
    tags:
      - WebScraping
    parameters:
...
@agente_scraping_bp.route('/select', methods=['POST'])
def select():
    """
    Guardar selección de imágenes y gifs
    ---
    tags:
      - WebScraping
    consumes:
    ...
    collection_selecciones.insert_one(doc)
